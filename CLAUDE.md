...
public/                 — Static assets, icons, sw.js, fonts
...
- `components/paper-backdrop.tsx` — Light mode's ground: a procedural paper grain you can draw graphite on with the pointer. Not persisted; the eraser appears in the corner control cluster only once something has been drawn.
