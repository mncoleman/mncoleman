...
const Waves: React.FC<WavesProps> = ({
  ...
  return (
    ...
    >
      {/* Upstream ships its own 8px cursor dot here. This site already draws a custom
          cursor (components/ui/CustomCursor.tsx), so leaving it in renders a second dot
          trailing the first. The element stays — the wave field reads --x/--y off it —
          but it is invisible. */}
      <div
        aria-hidden
        className="absolute top-0 left-0 w-[0.5rem] h-[0.5rem] rounded-full opacity-0"
        style={{
